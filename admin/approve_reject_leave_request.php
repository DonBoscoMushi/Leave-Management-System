...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-file-code-o"></i> Review Leave Request</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="profile.php">Profile</a></li>
              ...
              <div class="tile user-settings">
                <h4 class="line-head">Details about the leave request</h4>
                <form>
                  <div class="row mb-4">
                    <div class="col-md-4">
                      <label>First Name</label>
                      <label class="breadcrumb" type="text"><?php echo $firstname; ?></label>
                    </div>
                    <div class="col-md-4">
                      <label>Last Name</label>
                      <label class="breadcrumb" type="text"><?php echo $lastname; ?></label>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-8 mb-4">
                      <label>Email</label>
                      <label class="breadcrumb" type="text"><?php echo $email; ?></label>
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-md-8 mb-4">
                      <label>Mobile No</label>
                      <label class="breadcrumb" type="text"><?php echo $phone; ?></label>
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-md-8 mb-4">
                      <label>Office Phone</label>
                      <label class="breadcrumb" type="text">
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-md-8 mb-4">
