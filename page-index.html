  ...
  <body class="landing-page">
    ...
    <section class="landing-hero">
      ...
      <div class="landing-hero-content">
        ...
        <div><a class="btn btn-primary mr-4" href="dashboard.php">Demo</a><a class="btn btn-primary" href="https://github.com/pratikborsadiya/vali-admin" target="_blank" rel="noopener">GitHub</a></div><img class="landing-hero-banner" src="images/banner.jpg">
      </div>
    </section>
